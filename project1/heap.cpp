...
void Heap::heapify(HEAP heap) {

  //TODO

}

HEAP Heap::initialze(int n) {
...
void Heap::BuildHeap(HEAP heap, ELEMENT* A, int n, int flag){
...
ELEMENT Heap::DeleteMax(HEAP heap, int flag) {
...
void Heap::IncreaseKey(HEAP heap, int index, int value, int flag) {
